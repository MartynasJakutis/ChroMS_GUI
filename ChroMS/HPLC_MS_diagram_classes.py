...
class MS_Diagram(Diagram):
    def __init__(self, dpi, need_title1, title1, title1_pos, title1_text_color, 
        ...
        self.use_scinot1 = use_scinot1
        self.use_scinot2 = use_scinot2
    ...
    def plotting_term_state_ms(self, subplot, data_mz, data_inten, purpose):
        ...
        if type(data_mz) != int:
            ...
            if use_scinot_dict.get(purpose):
                subplot.ticklabel_format(axis = "y", style = "sci", scilimits = (0, 0),
                                         useOffset = True, useLocale = True, useMathText = True)
            self.set_xlim_ylim_ms(subplot = subplot, data_mz = data_mz, data_inten = data_inten_term)
